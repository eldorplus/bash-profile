...
# Bash Theme Chooser by fox (fox91 at anche dot no)
...
THEMES_DIR="$BASH/themes"
FAVLIST="${HOME}/.bash_favlist"
source $BASH/bash-profile.sh
...
function theme_preview() {
    THEME=$1
    THEME_NAME=`echo $THEME | sed s/\.BASH-theme$//`
