...
BASH_THEME_TERM_TAB_TITLE_IDLE="%15<..<%~%<<" #15 char left truncated PWD
BASH_THEME_TERM_TITLE_IDLE="%n@%m: %~"

#Appears when you have the prompt
function omz_termsupport_precmd {
  title $BASH_THEME_TERM_TAB_TITLE_IDLE $BASH_THEME_TERM_TITLE_IDLE
}
